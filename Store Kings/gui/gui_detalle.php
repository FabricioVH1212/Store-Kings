                ...
                <div class="panel panel-inverse">
                        <div class="alert alert-secondary fade show"style="height:50px;">
                              <div class="float-left">
                                  <a href="historial.php"class="btn btn-warning"><i class="fa fa-arrow-circle-left col-lg"aria-hidden="true"></i></a>
                              </div>
                                          ...
                                          <table class="table table-striped table-bordered table-hover table-dark text-dark table-responsive">
                                              ...
                                              <?php
                                                ...
                                                <div class="row centrado">
                                                 ...
                                                 <p class="h5 text-center">Muchas gracias por su compra 
                                                        <?=" ".$_SESSION["USUARIO"]["CLIENTE"]["NOMBRE"];?>.<br>Recuerde que Store Kings hace que se vista como un rey</p>
                                      </div> 
                                      <!-- end panel-body -->
                                  </div>
                                  <!-- end panel -->
