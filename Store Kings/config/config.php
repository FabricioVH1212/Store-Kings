...
define("ESTILOS_EMAIL", '	<style type="text/css">
		/******************************************************
	...
	');	
	define('CONFIG_PATH_RDN', 'rdn/');
	define('CONFIG_PATH_GUI', 'gui/');
	define("CONFIG_PATH_JS",'js/');
	define("CONFIG_PATH_INC",'inc/');
	define("CONFIG_PATH_PROCESS",'process/');
	define("CONN", 'conn/');
	define("ROOT", "../"); 

	//conexión con la bases de datos
	require_once('conexion.php');
	include(CONFIG_PATH_RDN.'rdn_funciones.php');

	//variables del servidor
	$_SESSION["USUARIO"]["host"] = $_SERVER["HTTP_HOST"];
	$_SESSION["USUARIO"]["URL"] = $_SERVER["REQUEST_URI"];
	$array_url = explode("/", $_SESSION["USUARIO"]["URL"] );
	$final_url = sizeof($array_url);
	$_SESSION["USUARIO"]["PAGINA"] = $array_url[$final_url-1];
?>